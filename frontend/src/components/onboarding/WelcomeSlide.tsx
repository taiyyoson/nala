...
export default function WelcomeSlide({ goToNextSlide }: Props) {
  return (
    <View style={styles.container}>
      ...
      Nala is a digital health coach that will help you develop lifestyle and behavior change skills. Nala will help you to set goals for health and wellness, check in on your progress, and problem solve with you when things are difficult. Nala’s goal is to help you to increase your confidence to achieve your goals. 
